        ...
        <div className="container container--height-full">
          <div className="header__wrap">
            ...
            <div className="top-right-wrap">
              <Button text={"Log In"} modificator={"login-btn"} onClick={() => loginWithRedirect()}></Button>
              <Link to="/profile"><img className='header-photo' src={user?.picture} alt={user?.name}/></Link>
            </div>
          </div>
            {theme === 'dark'
        ...
        <div className="bottom">
          ...
          <nav className="header__nav">
            ...
            <ul className="nav__list">
              {!isAuthenticated
                ? <li className="nav__item"><Button text={"Log In"} onClick={() => loginWithRedirect()}></Button></li>
                : <>
